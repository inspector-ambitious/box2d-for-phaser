...
//		}
	...
	if (true)
	{
		...
		/*box2d.b2Vec2*/ var x = new box2d.b2Vec2(-7.0, 0.75);
		/*box2d.b2Vec2*/ var y = new box2d.b2Vec2();
		/*box2d.b2Vec2*/ var deltaX = new box2d.b2Vec2(0.5625, 1.25);
		/*box2d.b2Vec2*/ var deltaY = new box2d.b2Vec2(1.125, 0.0);
...
{
	/*const box2d.b2ContactManager*/ var cm = this.m_world.GetContactManager();
	/*int32*/ var height = cm.m_broadPhase.GetTreeHeight();
	/*int32*/ var leafCount = cm.m_broadPhase.GetProxyCount();
