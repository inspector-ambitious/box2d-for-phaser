...
box2d.Testbed.Car = function (canvas, settings)
{
	...
	if (true)
	{
		...
		/*float32[]*/ var hs = [0.25, 1.0, 4.0, 0.0, 0.0, -1.0, -2.0, -2.0, -1.25, 0.0];

		/*float32*/ var x = 20.0, y1 = 0.0, dx = 5.0;
	...
	if (true)
	{
		...
		for (/*int32*/ var i = 0; i < N; ++i)
		{
			...
			/*box2d.b2Vec2*/ var anchor = new box2d.b2Vec2(160.0 + 2.0 * i, -0.125);
		...
		/*box2d.b2Vec2*/ var anchor = new box2d.b2Vec2(160.0 + 2.0 * N, -0.125);
	...
	if (true)
	{
		...
		/*box2d.b2Vec2*/ var axis = new box2d.b2Vec2(0.0, 1.0);
