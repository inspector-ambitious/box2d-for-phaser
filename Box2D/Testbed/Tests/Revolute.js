...
box2d.Testbed.Revolute = function (canvas, settings)
{
	...
	{
		/*box2d.b2CircleShape*/ var circle_shape = new box2d.b2CircleShape();
		...
		polygon_body.CreateFixture2(polygon_shape, 2.0);
	...
	// Tests mass computation of a small object far from the origin
	{
		...
		/*box2d.b2Body*/ var body = this.m_world.CreateBody(bodyDef);
