...
box2d.std_sort = function (array, first, len, cmp)
{
	...
	if (typeof(cmp) !== 'function') cmp = function (a, b) { return a < b; };
 ...
 * @type {function():?}
 */
box2d.b2GrowableBuffer.prototype.allocator = function () { return null; };
 ...
 * @param {number} w 
 */
box2d.b2ParticleContact.prototype.SetWeight = function (w) { this.weight = w; }
 ...
 */
box2d.b2ParticleContact.prototype.SetNormal = function (n) { this.normal.Copy(n); }
 ...
 * @param {number} f 
 */
box2d.b2ParticleContact.prototype.SetFlags = function (f) { this.flags = f; }

/** 
 * @export 
 * @return {number}
 */
box2d.b2ParticleContact.prototype.GetIndexA = function () { return this.indexA; }

/** 
 * @export 
 * @return {number}
 */
box2d.b2ParticleContact.prototype.GetIndexB = function () { return this.indexB; }

/** 
 * @export 
 * @return {number}
 */
box2d.b2ParticleContact.prototype.GetWeight = function () { return this.weight; }

/** 
 * @export 
 * @return {box2d.b2Vec2}
 */
box2d.b2ParticleContact.prototype.GetNormal = function () { return this.normal; }

/** 
 * @export 
 * @return {number}
 */
box2d.b2ParticleContact.prototype.GetFlags = function () { return this.flags; }
...
box2d.b2ParticleContact.prototype.ApproximatelyEqual = function (rhs)
{
	...
	return this.indexA === rhs.indexA
		&& this.indexB === rhs.indexB
		&& this.flags === rhs.flags
		&& box2d.b2Abs(this.weight - rhs.weight) < MAX_WEIGHT_DIFF
		&& box2d.b2DistanceSquared(this.normal, rhs.normal) < MAX_NORMAL_DIFF_SQ;
}
...
box2d.b2ParticleSystem.prototype._ctor_ = function (def, world)
{
	...
	this.m_stuckParticleBuffer = new box2d.b2GrowableBuffer(function () { return 0; });
	this.m_proxyBuffer = new box2d.b2GrowableBuffer(function () { return new box2d.b2ParticleSystem.Proxy(); });
	this.m_contactBuffer = new box2d.b2GrowableBuffer(function () { return new box2d.b2ParticleContact(); });
	this.m_bodyContactBuffer = new box2d.b2GrowableBuffer(function () { return new box2d.b2ParticleBodyContact(); });
	this.m_pairBuffer = new box2d.b2GrowableBuffer(function () { return new box2d.b2ParticlePair(); });
	this.m_triadBuffer = new box2d.b2GrowableBuffer(function () { return new box2d.b2ParticleTriad(); });
...
{
	var s_aabb = new box2d.b2AABB(); // TODO: static
	box2d.b2Assert(this.m_world.IsLocked() === false);
	if (this.m_world.IsLocked())
	{
		return 0;
...
{
	var s_transform = new box2d.b2Transform(); // TODO: static
...
{
	var s_v = new box2d.b2Vec2(); // TODO: static
...
{
	var s_aabb = new box2d.b2AABB(); // TODO: static
	var s_p = new box2d.b2Vec2(); // TODO: static
	var s_v = new box2d.b2Vec2(); // TODO: static
	var s_n = new box2d.b2Vec2(); // TODO: static
	var s_point = new box2d.b2Vec2(); // TODO: static
	if (this.m_proxyBuffer.count === 0)
	{
		return;
	}
...
{
	var s_edge = new box2d.b2EdgeShape(); // TODO: static
	var s_d = new box2d.b2Vec2(); // TODO: static
	var s_p = new box2d.b2Vec2(); // TODO: static
	...
	for (var childIndex = 0; childIndex < childCount; childIndex++)
	{
		/** @type {box2d.b2EdgeShape} */ var edge = null;
...
{
	var s_dab = new box2d.b2Vec2(); // TODO: static
	var s_dbc = new box2d.b2Vec2(); // TODO: static
	var s_dca = new box2d.b2Vec2(); // TODO: static
	var pos_data = this.m_positionBuffer.data;
...
box2d.b2ParticleSystem.InitializeParticleLists = function (group, nodeBuffer)
{
	...
	for (var i = 0; i < particleCount; i++)
	{
		/*ParticleListNode**/ var node = nodeBuffer[i];
		node.list = node;
		node.next = null;
		node.count = 1;
...
box2d.b2ParticleSystem.prototype.MergeParticleListsInContact = function (group, nodeBuffer)
{
	...
	for (var k = 0; k < this.m_contactBuffer.count; k++)
	{
		/*const b2ParticleContact&*/ var contact = this.m_contactBuffer.data[k];
		var a = contact.indexA;
		var b = contact.indexB;
		if (!group.ContainsParticle(a) || !group.ContainsParticle(b)) {
			continue;
		}
		/*ParticleListNode**/ var listA = nodeBuffer[a - bufferIndex].list;
		/*ParticleListNode**/ var listB = nodeBuffer[b - bufferIndex].list;
		if (listA === listB) {
			continue;
		}
		...
		{
			var _tmp = listA; listA = listB; listB = _tmp; //b2Swap(listA, listB);
		}
...
box2d.b2ParticleSystem.MergeParticleLists = function (listA, listB)
{
	...
	{
		b.list = listA;
		/*ParticleListNode**/ var nextB = b.next;
		if (nextB)
		{
			b = nextB;
		}
...
{
	var particleCount = group.GetParticleCount();
	/*ParticleListNode**/ var result = nodeBuffer[0];
	for (var i = 0; i < particleCount; i++)
	{
		/*ParticleListNode**/ var node = nodeBuffer[i];
...
box2d.b2ParticleSystem.prototype.CreateParticleGroupsFromParticleList = function (group, nodeBuffer, survivingList)
{
	...
	for (var i = 0; i < particleCount; i++)
	{
		/*ParticleListNode**/ var list = nodeBuffer[i];
		if (!list.count || list === survivingList)
		{
			continue;
		}
		box2d.b2Assert(list.list === list);
		/*b2ParticleGroup**/ var newGroup = this.CreateParticleGroup(def);
...
box2d.b2ParticleSystem.prototype.FilterContacts = function (contacts)
{
	...
	{
	    return (contact.flags & box2d.b2ParticleFlag.b2_particleContactFilterParticle)
...
{
	var s_n = new box2d.b2Vec2(); // TODO: static
	var s_rp = new box2d.b2Vec2(); // TODO: static
...
{
	var s_subStep = new box2d.b2TimeStep(); // TODO: static
	if (this.m_count === 0)
	{
		return;
	}
...
{
	var s_p1 = new box2d.b2Vec2(); // TODO: static
	var s_output = new box2d.b2RayCastOutput(); // TODO: static
	var s_input = new box2d.b2RayCastInput(); // TODO: static
	var s_p = new box2d.b2Vec2(); // TODO: static
	var s_v = new box2d.b2Vec2(); // TODO: static
	var s_f = new box2d.b2Vec2(); // TODO: static
 ...
 * @param {number} index 
 */
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportParticle = function (system, index) { return false; }
...
{
	var s_gravity = new box2d.b2Vec2(); // TODO: static
	var vel_data = this.m_velocityBuffer.data;
...
{
	var s_aabb = new box2d.b2AABB(); // TODO: static
	var s_va = new box2d.b2Vec2(); // TODO: static
	var s_vb = new box2d.b2Vec2(); // TODO: static
	var s_pba = new box2d.b2Vec2(); // TODO: static
	var s_vba = new box2d.b2Vec2(); // TODO: static
	var s_vc = new box2d.b2Vec2(); // TODO: static
	var s_pca = new box2d.b2Vec2(); // TODO: static
	var s_vca = new box2d.b2Vec2(); // TODO: static
	var s_qba = new box2d.b2Vec2(); // TODO: static
	var s_qca = new box2d.b2Vec2(); // TODO: static
	var s_dv = new box2d.b2Vec2(); // TODO: static
	var s_f = new box2d.b2Vec2(); // TODO: static
	var pos_data = this.m_positionBuffer.data;
	var vel_data = this.m_velocityBuffer.data;
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function ()
{
	...
	var s_t1 = new box2d.b2Vec2(); // TODO: static
	var s_p = new box2d.b2Vec2(); // TODO: static
	var s_v = new box2d.b2Vec2(); // TODO: static
...
{
	var s_position = new box2d.b2Vec2(); // TODO: static
	var s_rotation = new box2d.b2Rot(); // TODO: static
	var s_transform = new box2d.b2Transform(); // TODO: static
	var s_velocityTransform = new box2d.b2Transform(); // TODO: static
	var pos_data = this.m_positionBuffer.data;
	var vel_data = this.m_velocityBuffer.data;
	for (var group = this.m_groupList; group; group = group.GetNext())
	{
		if (group.m_groupFlags & box2d.b2ParticleGroupFlag.b2_rigidParticleGroup)
		{
			...
			var rotation = s_rotation; rotation.SetAngle(step.dt * group.m_angularVelocity);
			...
			var position = box2d.b2Add_V2_V2(
				...
				box2d.b2Sub_V2_V2(
					...
					box2d.b2Vec2.s_t0), 
				s_position);
			var transform = s_transform; transform.SetPositionRotation(position, rotation);
...
{
	var s_pa = new box2d.b2Vec2(); // TODO: static
	var s_pb = new box2d.b2Vec2(); // TODO: static
	var s_pc = new box2d.b2Vec2(); // TODO: static
	var s_r = new box2d.b2Rot(); // TODO: static
	var s_t0 = new box2d.b2Vec2(); // TODO: static
	var pos_data = this.m_positionBuffer.data;
	var vel_data = this.m_velocityBuffer.data;
...
{
	var s_weightedNormal = new box2d.b2Vec2(); // TODO: static
	var s_s = new box2d.b2Vec2(); // TODO: static
	var s_f = new box2d.b2Vec2(); // TODO: static
	var vel_data = this.m_velocityBuffer.data;
...
box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts = function ()
{
	...
	var s_n = new box2d.b2Vec2(); // TODO: static
	var s_pos = new box2d.b2Vec2(); // TODO: static
	var s_normal = new box2d.b2Vec2(); // TODO: static
